...
{
	m_vPosition = osg::Vec3(0.0f, 0.0f, 19.5f); //启始位置
	m_vRotation = osg::Vec3(osg::PI_2, 0.0f, 0.0f); //启始角度
}
...
//设置起始角度
void TravelManipulator::SetRotation(osg::Vec3 &Rotation)
{
...
//获取相机的旋转
osg::Vec3 TravelManipulator::Get_Rotation()
{
	return m_vRotation;
}